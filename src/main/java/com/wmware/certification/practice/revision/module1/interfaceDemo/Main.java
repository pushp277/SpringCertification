package com.wmware.certification.practice.revision.module1.interfaceDemo;


/**
 * @author Raj, Pushp
 * Demo for Interface
 * @see com.wmware.certification.practice.revision.module1.interfaceDemo.InterfaceDemo
 */
